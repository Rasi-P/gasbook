    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('cash', 'Cash'), ('gpay', 'GPay'), ('bank', 'Bank Transfer'), ('credit', 'Credit/Pending'), ('split', 'Split Payment')], default='credit', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_mode', models.CharField(choices=[('cash', 'Cash'), ('gpay', 'GPay'), ('bank', 'Bank Transfer'), ('credit', 'Credit/Pending'), ('split', 'Split Payment')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('payment_mode', models.CharField(choices=[('cash', 'Cash'), ('gpay', 'GPay'), ('bank', 'Bank Transfer'), ('credit', 'Credit/Pending'), ('split', 'Split Payment')], default='cash', max_length=10)),
                ('note', models.CharField(blank=True, max_length=200)),
                ('empty_collected', models.PositiveIntegerField(default=0)),
